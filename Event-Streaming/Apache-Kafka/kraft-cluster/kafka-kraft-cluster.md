...
```
$ sudo keytool -keystore kafka-1.keystore.jks -alias kafka-1 -validity 3650 -genkey -storepass sls1234567 -keypass sls1234567 -dname "CN=kafka-1" -ext SAN=dns:kafka-1 -keyalg RSA -storetype pkcs12
```

#### Create CSR
```
$ sudo keytool -keystore kafka-1.keystore.jks -alias kafka-1 -certreq -file kafka-1.csr -storepass sls1234567 -keypass sls1234567
```
#### Create cert signed by CA
```
$ sudo openssl x509 -req -CA ca.crt -CAkey ca.key -in kafka-1.csr -out kafka-1-ca1-signed.crt -days 9999 -CAcreateserial -passin pass:sls1234567
```
...
```
$ sudo keytool -keystore kafka-1.keystore.jks -alias CARoot -import -noprompt -file ca.crt -storepass sls1234567 -keypass sls1234567
```
#### Import signed cert into keystore
```
$ sudo keytool -keystore kafka-1.keystore.jks -alias kafka-1 -import -noprompt -file kafka-1-ca1-signed.crt -storepass sls1234567 -keypass sls1234567
```
#### import CA cert into truststore
```
$ sudo keytool -keystore kafka-1.truststore.jks -alias CARoot -import -noprompt -file ca.crt -storepass sls1234567 -keypass sls1234567
```
